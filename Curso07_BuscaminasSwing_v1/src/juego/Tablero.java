...
public class Tablero extends JPanel {
	...
	private Buscaminas juegoAsociado;
		
	public Tablero(Buscaminas b, int filas, int columnas, int numBombasTotal) {
		super();
		
		this.juegoAsociado = b;
